...
news_dataset = pd.read_csv('Datasets/covid_fake_news_data.csv')
...
X = news_dataset.drop(columns='outcome', axis=1)
Y = news_dataset['outcome']
print('X', X)
print('Y', Y)
...
print(news_dataset['headlines'])
news_dataset['headlines'] = news_dataset['headlines'].apply(stemming)
print('stemming facn: ',news_dataset['headlines'])
#
X = news_dataset['headlines'].values
